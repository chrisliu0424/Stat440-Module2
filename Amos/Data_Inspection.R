...
X_train = read.table('./GitHub/Stat440-Module2/ChrisL/Data_Original/Xtrain.txt',sep = ' ',header = TRUE)
X_test = read.table('./GitHub/Stat440-Module2/ChrisL/Data_Original/Xtest.txt',sep = ' ',header = TRUE)
Y_train = read.table('./GitHub/Stat440-Module2/ChrisL/Data_Original/Ytrain.txt',sep = ' ',header = TRUE)
Y_test = read.table('./GitHub/Stat440-Module2/ChrisL/Data_Original/Ytest.txt',sep = ',',header = TRUE)
...
hist(as.numeric(X_train[,2]),main = paste0("variable ",colnames(X_train)[2])) 
hist(as.numeric(Y_train[,4]),main = paste0("variable ",colnames(Y_train)[4])) 
